  ...
  return (
    <div className="bg-white rounded-3xl shadow-[0px_10px_30px_rgba(94,35,220,0.04)] overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-8">
        ...
        <h3 className="text-xl font-medium text-[#151C27] leading-[30px] mb-4">
          {title}
        </h3>
  ...
  return (
    <div className="border border-[#CBC3D8] rounded-2xl overflow-hidden">
      <button
        ...
        className="w-full flex justify-between items-center px-6 py-[22px] text-left gap-4 hover:bg-gray-50 transition-colors"
      >
...
export default function FindVerifiedProperties({
  ...
  const journeySteps = [
    ...
    },
    {
      ...
      desc: "Our experts curate the best options matching your profile.",
    },
    {
      num: 3,
      title: "Site Visit",
      desc: "Guided visits with experts for honest property insights.",
    },
    {
      num: 4,
      title: "Legal Verification",
      desc: "Professional documentation and legal checks for peace of mind.",
    },
    {
      num: 5,
      title: "Possession",
  ...
  return (
    <div className="bg-[#F9F9FF] font-['Segoe_UI',sans-serif] text-[#151C27] min-w-0">
      ...
      <section className="bg-white relative overflow-hidden min-h-[640px] lg:min-h-[700px]">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-[30%] bg-[#E4E0EF] rounded-bl-[120px] hidden lg:block" />

        <div className="max-w-[1440px] mx-auto px-5 sm:px-10 lg:px-20 py-16 lg:pb-20 relative">
          <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="flex-1 min-w-0 z-10">
              ...
              <div className="inline-flex items-center gap-2 bg-[#E4E0EF] rounded-full px-3 py-1.5 mb-6">
                ...
                <span className="text-[#4500B4] text-sm">
                  Trusted • Verified • Zero Brokerage
                </span>
              </div>
              ...
              <div className="border-t border-[#CBC3D8] pt-8">
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={s.label}>
                      <p className="text-base font-medium text-[#4500B4]">
                        {s.val}
                      </p>
                      <p className="text-xs text-[#5F5D69] uppercase tracking-[0.6px] mt-0.5">
                        {s.label}
                      </p>
                    </div>
                  ))}
            ...
            <div className="w-full lg:w-[40%] flex-shrink-0 z-10">
              <div className="relative rounded-[32px] overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
                {/* Main building image */}
                <div className="w-full h-[320px] sm:h-[400px] lg:h-[550px] flex items-center justify-center relative">
                  <img
                    src="/assets/seoPages/verifiedProperties/hero.svg"
                    alt="hero image"
                    className="w-full h-full object-cover"
                  />
                  {/* Gradient overlay */}
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-16">
          <div className="text-center mb-10">
            <h2 className="text-3xl sm:text-[32px] font-bold text-[#151C27] tracking-[-0.32px] mb-4">
              What Are You Looking For?
            </h2>
            <p className="text-base text-[#5F5D69]">
              Tailored categories to simplify your home search in Nagpur
            </p>
          </div>
      ...
      <section className="bg-[#F9F9FF] py-20 sm:py-24" id="featured-properties">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-16">
          <div className="flex items-end justify-between mb-10 gap-4">
            <div>
              <h2 className="text-3xl sm:text-[32px] font-bold text-[#151C27] tracking-[-0.32px] mb-2">
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-14 xl:gap-20 items-center">
            {/* Left */}
            <div>
              <h2 className="text-3xl sm:text-[32px] font-bold text-[#151C27] tracking-[-0.32px] mb-5">
                We Build Trust, Not Just Transactions
              </h2>
              <p className="text-lg text-[#5F5D69] leading-7 mb-10">
                Reparv is built to remove confusion, risk, and hidden costs from
                property buying and selling in Nagpur. We focus on transparency
                for every customer.
              </p>
            ...
            <div className="relative">
              <div className="rounded-[48px] overflow-hidden h-[400px] lg:h-[516px] flex items-center justify-center relative">
                <img src="/assets/seoPages/verifiedProperties/image.svg" alt="hero image" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="bg-[#F9F9FF] py-20 sm:py-24">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-16">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-[#5F5D69]">
              A simple, transparent process designed to save you time and money.
            </p>
          </div>
          {/* Steps */}
          <div className="relative">
              ...
              <div className="p-10 sm:p-16 lg:p-20 flex flex-col gap-8">
                ...
                <div className="bg-white/10 border border-white/20 rounded-2xl p-6">
                  <p className="text-base italic text-white/90 leading-6 mb-4">
                    "The Reparv team made my first home buying experience in
                    Nagpur absolutely stress-free. No brokerage and complete
                    legal peace of mind."
                  </p>
                  <p className="text-base text-white">
                    — Rahul Deshmukh, Homeowner
                  </p>
                </div>
              </div>
      ...
      <section className="bg-[#F9F9FF] py-20 sm:py-24">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 lg:px-16">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-[32px] font-bold text-[#151C27] tracking-[-0.32px] mb-4">
              Property Insights &amp; Buying Guides
            </h2>
            <p className="text-base text-[#5F5D69]">
              Stay informed with expert-written guides and local market
              insights.
            </p>
          </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          <div className="relative bg-gradient-to-br from-[#4500B4] to-[#5E23DC] rounded-[48px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] px-10 sm:px-24 py-24 overflow-hidden text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl sm:text-5xl font-bold text-white tracking-[-0.96px] mb-4">
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="max-w-[768px] mx-auto px-4 sm:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-base text-[#5F5D69]">
              Common questions buyers and sellers ask before dealing in property
              in Nagpur.
            </p>
          </div>
