const reasons = [
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.911 3.374h14.784c1.694 0 2.777-1.874 1.911-3.374L13.911 5.625a2.121 2.121 0 00-3.822 0L2.697 16.126z" />
      </svg>
    ),
    ...
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-3 flex items-center gap-2">
          ...
          <p className="text-[#4500B4] text-sm font-semibold tracking-wide uppercase">Understanding the Challenge</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {reasons.map((r, i) => (
            ...
            >
              ...
              <h3 className="text-[#1a0a3d] font-semibold text-base mb-2">{r.title}</h3>
              <p className="text-[#6b6490] text-sm leading-relaxed">{r.desc}</p>
            </div>
          ))}
        </div>
      </div>
